...
Project-specific acceptance focus: Use multilingual adversarial and benign corpora; measure false positives/negatives, encoding bypasses, indirect injection, PII leakage, streaming behavior, detector outage, latency, policy versioning, redaction, and tenant isolation.
